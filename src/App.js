            ...
            <div className="colorComp">
                    ...
                    totalValue = {this.state.cardCount}
                      data={[
                        ...
                        { title: `Black ${this.state.black/colorSum*100}%`, value: this.state.black, color: 'black' },
                        { title: `Blue ${this.state.blue/colorSum*100}%`, value: this.state.blue, color: 'blue' },
                        { title: `White ${this.state.white/colorSum*100}%`, value: this.state.white, color: 'white' },
